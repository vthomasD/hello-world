  ...
  <div class="w3-container w3-content w3-padding-64" style="max-width:800px" id="contact">
    ...
    <div class="w3-row w3-padding-32">
      <div class="w3-col m6 w3-large w3-margin-bottom">
        <i class="fa fa-map-marker" style="width:30px"></i> Mamallapuram, Singara Chennai<br>
        <i class="fa fa-phone" style="width:30px"></i> Phone: +91 9677250048<br>
        <i class="fa fa-envelope" style="width:30px"> </i> Email: krishgokul9677@gmail.com<br>
      </div>
      <div class="w3-col m6">
